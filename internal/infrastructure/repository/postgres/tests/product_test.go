...
//			)
//
//		mock.ExpectQuery("SELECT id, seller_id, name, preview_image_url, description, status, price, quantity, updated_at, rating, reviews_count FROM bazaar.product").
//			WillReturnRows(rows)
//
...
//			)
//
//		mock.ExpectQuery("SELECT id, seller_id, name, preview_image_url, description, status, price, quantity, updated_at, rating, reviews_count FROM bazaar.product WHERE id = \\$1").
//			WithArgs(testID).
//			WillReturnRows(row)
//
