...
### pickup_point
`{id} → {city, street, house, zip_code, created_at, updated_at}`  
**1NF**: ✓ **2NF**: ✓ **3NF**: ✓ **NFBC**: ✓

### user_pickup_point
`{id} → {user_id, pickup_point_id, created_at}`  
**1NF**: ✓ **2NF**: ✓ **3NF**: ✓ **NFBC**: ✓
...
- **NFBC**: Все детерминанты являются потенциальными ключами
